...
<template>
    <div class="rounded-xl p-3 flex gap-[3px] items-center bg-surface shadow-custom-card">
        ...
        <div class="text-main-blue flex flex-col gap-1">
            <span class="text-[14px] ">{{ activity }}</span>
            <span class="text-base font-semibold">{{ time }} WIB</span>
        </div>
        <div class="text-main-blue flex flex-col gap-1">
            <span class="text-[14px] font-medium ">{{ date }}</span>
